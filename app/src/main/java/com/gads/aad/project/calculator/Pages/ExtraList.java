...
import com.gads.aad.project.calculator.Backend.App;
...
import com.gads.aad.project.calculator.Backend.SavedData;
...
import com.gads.aad.project.calculator.Supporting.FavAdapter;
import com.gads.aad.project.calculator.Supporting.MoreAppAdapeter;
import com.gads.aad.project.calculator.Supporting.SavedAdapter;
...
public class ExtraList extends AppCompatActivity implements SavedAdapter.AdapterCallback {
    ...
    private void favClicked() {
        ...
        String[] allTitles=new String[titleGen.length+titleGpa.length+titlePer.length];
        int[] allImages=new int[titleGen.length+titleGpa.length+titlePer.length];
